...
function generateSecretKey(): string {
    ...
    if (typeof window !== 'undefined' && window.crypto) {
        ...
        console.error('window is not defined or crypto is not available')
    }
...
export function calculateHMAC(secretKey: string, secret: string): string {
...
export function encodeBase64(secretKey: string, hmac: string): string {
