...
const CaraPemesanan = () => {
  return (
    <>
      <CaraPemesananList nama={"SMS Advertising"} items={caraPemesanan} />
    </>
  );
};
...
const caraPemesanan = [
  {
    title: "Pilih Layanan",
    desc: "Pilih jenis layanan SMS yang diinginkan di bawah ini",
  ...
  {
    title: "Isi Form",
    desc: "Isi form sesuai ketentuan sesuai dengan tipe SMS ads yang di inginkan",
