...
export const WhatsappBusinessFaqList: Items[] = [
  {
    id: 1,
    title: "Apa beda Chatbot dengan WhatsApp Business API?",
    content: `<p><span>Chatbot adalah robot virtual yang dapat mensimulasikan percakapan layaknya manusia. Chatbot merupakan sebuah program AI (Artificial Inteligence).</span></p>
<p><span>WhatsApp Business API adalah jenis layanan whatsapp untuk bertukar (mengirim &amp; menerima) pesan yang diperuntukan untuk skala menengah dan/atau perusahaan. Layanan ini bisa diprogram menjadi sebuah chatbot.</span></p>`,
  },
  {
    id: 2,
    title: "Jika client sudah punya Account/WABA-ID, apakah bisa digunakan?",
    content: `Bisa digunakan jika waba (WhatsApp Business Account) tersebut belum dikelola oleh partner atau BSP lain. Jika waba tersebut sudah dimiliki BSP maka untuk menggunakan nomor yang sama di lain BSP harus dimigrasikan terlebih dahulu.`,
  },
  {
    id: 3,
    title: "Simcard/Phone Number, apa hanya untuk operator tertentu atau all operator bisa digunakan?",
    content: `Bebas, silahkan menggunakan nomor operator manapun asalkan nomor tersebut aktif dan belum terdaftar sebagai pengguna whatsapp`,
  },
  {
    id: 4,
    title: "Apakah bisa menggunakan lebih dari 1 phone number?",
    content: `Bebas, silahkan menggunakan nomor operator manapun asalkan nomor tersebut aktif dan belum terdaftar sebagai pengguna whatsapp`,
  },
  {
    id: 5,
    title: `Berapa jumlah karakter untuk create display name?`,
    content: `<p><span>Minimal 3 karakter,&nbsp;</span><span>Info lebih lanjut untuk kebijakan dari display name silahkan buka link berikut&nbsp;</span><br /><a href="https://developers.facebook.com/docs/whatsapp/overview/display-name"><u><span>https://developers.facebook.com/docs/whatsapp/overview/display-name</span></u></a></p>`,
  },
  {
    id: 6,
...
const FaqList = () => {
  return <FrequentlyAskedQuestions items={WhatsappBusinessFaqList} name="Whatsapp Business Platform" />;
};
